...
package linux_i2c_dev_h is
  ...
  -- slave address			 
   type i2c_msg is record
      addr : aliased asm_generic_int_ll64_h.uu_u16;  -- /usr/include/linux/i2c-dev.h:38
      flags : aliased unsigned_short;  -- /usr/include/linux/i2c-dev.h:39
      len : aliased short;  -- /usr/include/linux/i2c-dev.h:46
      buf : Interfaces.C.Strings.chars_ptr;  -- /usr/include/linux/i2c-dev.h:47
   end record;
   pragma Convention (C_Pass_By_Copy, i2c_msg);  -- /usr/include/linux/i2c-dev.h:37
  ...
  --  
   ...
   type i2c_smbus_data (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            byte : aliased asm_generic_int_ll64_h.uu_u8;  -- /usr/include/linux/i2c-dev.h:90
         when 1 =>
            word : aliased asm_generic_int_ll64_h.uu_u16;  -- /usr/include/linux/i2c-dev.h:91
         when others =>
            block : aliased anon693_anon695_array;  -- /usr/include/linux/i2c-dev.h:92
      end case;
   end record;
   pragma Convention (C_Pass_By_Copy, i2c_smbus_data);
   pragma Unchecked_Union (i2c_smbus_data);  -- /usr/include/linux/i2c-dev.h:89
  ...
  -- This is the structure as used in the I2C_SMBUS ioctl call  
   type i2c_smbus_ioctl_data is record
      read_write : aliased asm_generic_int_ll64_h.uu_u8;  -- /usr/include/linux/i2c-dev.h:141
      command : aliased asm_generic_int_ll64_h.uu_u8;  -- /usr/include/linux/i2c-dev.h:142
      size : aliased asm_generic_int_ll64_h.uu_u32;  -- /usr/include/linux/i2c-dev.h:143
      data : access i2c_smbus_data;  -- /usr/include/linux/i2c-dev.h:144
   end record;
   pragma Convention (C_Pass_By_Copy, i2c_smbus_ioctl_data);  -- /usr/include/linux/i2c-dev.h:140

  -- This is the structure as used in the I2C_RDWR ioctl call  
  -- pointers to i2c_msgs  
   type i2c_rdwr_ioctl_data is record
      msgs : access i2c_msg;  -- /usr/include/linux/i2c-dev.h:149
      nmsgs : aliased asm_generic_int_ll64_h.uu_u32;  -- /usr/include/linux/i2c-dev.h:150
   end record;
   pragma Convention (C_Pass_By_Copy, i2c_rdwr_ioctl_data);  -- /usr/include/linux/i2c-dev.h:148
  ...
  -- number of i2c_msgs  
   function i2c_smbus_access
     (file : int;
      ...
      size : int;
      data : access i2c_smbus_data) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:156
   pragma Import (C, i2c_smbus_access, "i2c_smbus_access");

   function i2c_smbus_write_quick (file : int; value : asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:169
   pragma Import (C, i2c_smbus_write_quick, "i2c_smbus_write_quick");

   function i2c_smbus_read_byte (file : int) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:174
   pragma Import (C, i2c_smbus_read_byte, "i2c_smbus_read_byte");

   function i2c_smbus_write_byte (file : int; value : asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:183
   pragma Import (C, i2c_smbus_write_byte, "i2c_smbus_write_byte");

   function i2c_smbus_read_byte_data (file : int; command : asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:189
   pragma Import (C, i2c_smbus_read_byte_data, "i2c_smbus_read_byte_data");

   function i2c_smbus_write_byte_data
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      value : asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:199
   pragma Import (C, i2c_smbus_write_byte_data, "i2c_smbus_write_byte_data");

   function i2c_smbus_read_word_data (file : int; command : asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:208
   pragma Import (C, i2c_smbus_read_word_data, "i2c_smbus_read_word_data");

   function i2c_smbus_write_word_data
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      value : asm_generic_int_ll64_h.uu_u16) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:218
   pragma Import (C, i2c_smbus_write_word_data, "i2c_smbus_write_word_data");

   function i2c_smbus_process_call
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      value : asm_generic_int_ll64_h.uu_u16) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:227
  ...
  -- Returns the number of read bytes  
   function i2c_smbus_read_block_data
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      values : access asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:240
   ...
   function i2c_smbus_write_block_data
     (file : int;
      ...
      values : access asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:255
  ...
  --   2.6.23 and later.  
   ...
   function i2c_smbus_read_i2c_block_data
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      length : asm_generic_int_ll64_h.uu_u8;
      values : access asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:273
   ...
   function i2c_smbus_write_i2c_block_data
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      length : asm_generic_int_ll64_h.uu_u8;
      values : access asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:293
  ...
  -- Returns the number of read bytes  
   function i2c_smbus_block_process_call
     (file : int;
      command : asm_generic_int_ll64_h.uu_u8;
      length : asm_generic_int_ll64_h.uu_u8;
      values : access asm_generic_int_ll64_h.uu_u8) return asm_generic_int_ll64_h.uu_s32;  -- /usr/include/linux/i2c-dev.h:309
